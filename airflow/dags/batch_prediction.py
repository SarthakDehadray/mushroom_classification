...
with DAG(
    ...
    def download_files(**kwargs):
        ...
        os.system(f"aws s3 sync s3://{bucket_name}/inpu_files/app/input_files")
    ...
    def sync_prediction_dir_to_s3_bucket(**kwargs):
        bucket_name = os.getenv("BUCKET_NAME")
        #upload prediciton folder to prediction files folder in s3 bucket
        os.system(f"aws s3 sync /app/predictions3://{bucket_name}/prediction_files")
